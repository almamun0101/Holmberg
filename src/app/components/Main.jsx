      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="pt-40 text-center text-white">
          ...
          <p className="max-w-xl mx-auto text-sm sm:text-base">
            Lorem ipsum dolor sit amet, consectetur adipiscing. egestas viverra id aliquet. vulputate egestas sollicitudin.
          </p>
        </section>
        ...
        <section className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-white">
          {[
            ...
            >
              ...
              <h3 className="text-xl font-bold text-center">Focus only on Real activities</h3>
              <p className="text-xs leading-relaxed text-center max-w-xs">
                Lorem ipsum dolor amet, cotetur adipiscing elit. Neue enim diam nare sagittis, aliquet cursus.
              </p>
            </div>
          ))}
        </section>
          ...
          <div className="mt-10 grid gap-6 grid-cols-1 sm:grid-cols-2">
            {tool.map((t, index) => (
              <div key={index} className="flex gap-4 p-3 max-w-md mx-auto">
                <h2 className="text-4xl text-[#FFBD2F] font-extrabold min-w-[45px]">{t.serial}</h2>
                <div className="text-left">
                  <h3 className="text-base sm:text-lg font-bold pb-1">{t.title.toUpperCase()}</h3>
            ...
            <div className="flex flex-col gap-6">
              {[1, 2, 3].map((num) => (
                <div
                  ...
                  <div className={`flex items-center justify-center w-10 h-10 rounded-full ${num === 1 ? "bg-blue-500" : num === 2 ? "bg-yellow-500" : "bg-red-500"}`}>0{num}</div>
                  <div className="text-left">
                    <h3 className="font-bold text-sm sm:text-base pb-2">MANAGE YOUR WORKS EFFORTLESSLY</h3>
                    <p className="text-xs sm:text-sm">Lorem ipsum dolor amet, cotetur adipiscing elit. Neue enim diam nare sagittis, aliquet cursus.</p>
                  </div>
                </div>
              ))}
            </div>
            <div className="flex justify-center">
              <img src="/Images/visitgraph.png" alt="Graph" className="max-w-full h-auto rounded-2xl" />
            </div>
          </div>
        </section>
        ...
        <section className="mt-20 text-center text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <img src="/Images/Group 572.png" alt="Testimonial Group" className="mx-auto w-full max-w-xs sm:max-w-md" />
            <div className="px-6 max-w-md mx-auto">
              <img src="/Images/Vector2.png" alt="Quote" className="mx-auto" />
              <p className="mt-5 text-white/60 text-sm sm:text-base">
                "Dealing with sickle cell has been a lifelong rollercoaster. The thought of my voice being heard in the world of medicine is really what motivated me to join this study. Not only to advocate for myself but..."
              </p>
              <h3 className="pt-5 pb-1 text-xl sm:text-2xl">Jhony Bravo</h3>
              <p className="text-white/60 text-xs sm:text-sm">CEO, THEMEFISHER</p>
        ...
        <section className="mt-20 text-center text-white">
          <div className="flex flex-col lg:flex-row items-center justify-between bg-[#0c5f78] rounded-[2rem] p-8 gap-8 max-w-4xl mx-auto">
            <div className="flex-1">
              ...
              <button className="bg-yellow-500 hover:bg-yellow-600 px-6 py-3 rounded-2xl text-black font-semibold transition w-full sm:w-auto">Download The Theme</button>
            </div>
        ...
        <footer className="bg-[#0c5f78] text-white mt-20 px-6 py-10 text-center">
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            <div>
              ...
              <p className="text-xs sm:text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm">2118 Thornridge Cir. Syracuse, Connecticut 35624</p>
              <p className="text-xs sm:text-sm mt-1">(704) 555-0127</p>
            </div>
          </div>
          <hr className="my-8 border-white/20" />
          <p className="text-xs text-white/50">Designed By Themefisher, Developed by Gethugothemes</p>
        </footer>
      </div>
    </div>
  );
